...
import 'package:test/core/configs/base_API_configs.dart';
import 'package:test/core/env/app_state.dart';
import 'package:test/core/error/http_execption.dart';

class DioServicesAPI extends BaseAPIConfig {
  // base config options
  ...
  @override
  Future<List> getAPI({String? authorization, required String url}) async {
